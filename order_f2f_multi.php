    ...
    if (isset($_POST['submit']) && isset($captcha_flag) && $captcha_flag == 1) {
        ...
        and assignTime='$assignTime' and orgName='$orgName' and orgContact='$orgContact' and orgRef='$orgRef'");
            ...
            if ($val == 0) {
                ...
                if (isset($_POST['po_number']) && $_POST['po_number'] == 1 && !empty($_POST['purchase_order_number'])) {
...
<body class="boxed">
                ...
                <form class="sky-form" action="" method="post">
                    <div class="panel panel-primary setup-content" id="step-1">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="form-group col-md-4 col-sm-6" id="div_it" style="display:none;">
                            </div>
                            <div class="form-group col-md-6 col-sm-6" id="div_assignIssue" style="display:none;">
                            ...
                            <div class="form-group col-md-4 col-sm-6">
                                <label class="control-label">Assignment End Time
                                </label>
                    ...
                    <div class="panel panel-primary setup-content" id="step-2">
                        ...
                        <div class="panel-body">
                            <div class="form-group col-md-4 search-box">
                            ...
                            <div class="form-group col-md-3" title="System generated ID by LSUK">
                            ...
                            <div class="form-group col-md-4 col-sm-6 <?php if ($po_req == 0) {
                                ...
                                <br><span class="col-md-offset-2">
                                    <label class="checkbox-inline" style="margin-top: 4px;border: 1px solid lightgrey;padding: 2px 10px;"><input style="transform: scale(1.2);" onchange="booking_purch_order();" type="radio" name="po_number" value="1" checked> Yes</label>
                                    <label class="checkbox-inline" style="border: 1px solid lightgrey;padding: 2px 10px;"><input style="transform: scale(1.2);" onchange="booking_purch_order();" type="radio" name="po_number" value="0"> No</label>
                                </span>
                            </div>
                            <div class="form-group col-md-3 col-sm-6 <?php if ($po_req == 0) {
                                                                            echo 'hidden';
                            ...
                            <div id="div_po_req" class="form-group hidden col-md-3 col-sm-6">
                    ...
                    <div class="panel panel-primary setup-content" id="step-3">
                        ...
                        <div class="panel-body">
                            <div class="form-group col-md-4">
                                <label class="control-label optional">Post Code
                                </label>
                                <div class="input-group">
                                    <input id="postCode" class="form-control" name="postCode" type="text" placeholder="Search Post Code" class="form-control" required>
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <div class="input-group">
                                    <input placeholder="Building No / Name" id="buildingName" name="buildingName" class="form-control" readonly="readonly" type="text">
                                    <div class="input-group-btn">
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <select class="form-control" onchange="return PostCodeListChanged(this);" id="postcodelist" name="street"></select>
                            </div>
                            <div class="form-group col-md-4">
                    ...
                    <div class="panel panel-primary setup-content" id="step-4">
                        ...
                        <div class="panel-body">
                            ...
                            <!-- <div class="form-group col-md-4">
                                ...
                                <input onchange="OnDateChgAjax();" type="date" name="bookeddate" id="bookeddate" required='Booked Date' class="form-control date_picker" value="<?php echo @$bookedDate ?>" />
                            </div>
                            <div class="form-group col-md-4">
                    ...
                    <div class="panel panel-primary setup-content" id="step-5">
                        ...
                        <div class="panel-body">
                            <div class="form-group col-sm-5">
                                ...
                                <div class="radio-inline ri"><label><input name="dbs_checked" type="radio" value="0" checked="checked" />
                                        <span class="label label-primary">Yes <i class="fa fa-check-circle"></i></span></label></div>
                                <div class="radio-inline ri"><label><input type="radio" name="dbs_checked" value="1" />
                            ...
                            <div class="form-group col-sm-7">
                                ...
                                <div class="radio-inline ri"><label><input name="gender" type="radio" value="Male" checked="checked" />
                            ...
                            <div class="form-group col-sm-7 dJob">
    ...
    <script type="text/javascript">
        ...
        $('.nextBtn:eq(0)').click(function() {
            ...
            var assignment_category = $('#interp_cat').val();
            if (!check_languages && source_language && target_language && assignment_category) {
                set_language();
            }
        });
