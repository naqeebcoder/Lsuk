        ...
        <form class="sky-form" action="#" method="post">
            <section id="content" class="container_fluid clearfix">
                <div class="col-lg-6">
                    ...
                    <div class="form-group col-md-6 col-sm-6" id="div_tpt" style="display:none;">
                    </div>
                    <?php if (isset($_POST['submit']) && $val == 0 && !empty($_POST['telep_cat'])) {
                        $telep_cat = $_POST['telep_cat'];
                        $acttObj->editFun($table, $edit_id, 'telep_cat', $telep_cat);
                    }
                    if (isset($_POST['submit']) && $val == 0 && $_POST['telep_cat'] != '11') {
                    ...
                    <div class="form-group col-sm-8" id="div_assignIssue" style="display:none;">
                        ...
                        <?php if (isset($_POST['submit']) && $val == 0 && !empty($_POST['telep_cat']) && $_POST['telep_cat'] == '11') {
                    ...
                    <div class="form-group col-md-6 col-sm-6" title="System generated ID by LSUK">
                        ...
                        <input name="nameRef" type="text" required='' readonly="readonly" class="form-control" value="<?php $month = date('M');
                ...
                <div class="col-lg-6">
                    ...
                    <div class="form-group col-md-6 col-sm-6 search-box">
                        ...
                        <input class="form-control" name="orgRef" id="orgRef" type="text" required='' autocomplete="off" placeholder="Type Reference Number/Name" />
                    ...
                    <div class="form-group col-md-6 col-sm-6">
                        ...
                        <input onchange="OnTimeChgAjax();" type="time" name="bookedtime" id="bookedtime" required='' step="300" class="form-control time_picker2" value="<?php echo @$bookedTime ?>" />
                        <?php
                        if (isset($_POST['submit'])) {
...
<td style='border: 1px solid yellowgreen;padding:5px;'>" . $orgContact . "</td>
                    ...
                    if ($query_style == '0') {
                        ...
                        interpreter_reg.active='0' AND (interpreter_reg.actnow='Active' OR (interpreter_reg.actnow='Inactive' AND CURRENT_DATE() NOT BETWEEN interpreter_reg.actnow_time AND interpreter_reg.actnow_to)) AND interpreter_reg.telep='Yes' $put_gender AND interpreter_reg.deleted_flag=0 AND interpreter_reg.subscribe=1 AND interpreter_reg.is_temp=0 AND interpreter_reg.isAdhoc=0 AND interpreter_reg.on_hold='No'";
                    ...
                    $subject_int = "New Telephone Interpreting Project " . $edit_id;
                    $sub_title = "Telephone job of " . $source_lang_req . " language on " . $assignDate_req . " at " . $assignTime_req . " is available for you to bid.";
                    $type_key = "nj";
                    //$app_int_ids=array();
