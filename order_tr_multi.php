...
<head>
    ...
    if (isset($_POST['submit']) && isset($captcha_flag) && $captcha_flag == 1) {
        ...
        foreach ($array_languages as $language) {
            ...
            //waseem code , in case of Document Translation, these fields were empty becoz of which sql throw exception and all data goes empty
            if (isset($_POST['transType'])) {
                $transType = implode(",", $_POST['transType']);
                $acttObj->editFun($table, $edit_id, 'transType', $transType);
            } else {
                $acttObj->editFun($table, $edit_id, 'transType', '');
            }
            if (isset($_POST['trans_detail'])) {
                $trans_detail = implode(",", $_POST['trans_detail']);
                $acttObj->editFun($table, $edit_id, 'trans_detail', $trans_detail);
            } else {
                $acttObj->editFun($table, $edit_id, 'trans_detail', '');
            }
            // end of waseem changes
            ...
            try {
                ...
                if ($mail->send()) {
                    ...
                    if ($jobDisp_req == '1' && $jobStatus_req == '1') {
                        ...
                        $assignDate_req = $misc->dated($_POST['deliverDate']);
                        $append_table = "
                        <table>
                        <tr>
                        <td style='border: 1px solid yellowgreen;padding:5px;'>Source Language</td>
...
<body class="boxed">
    ...
    <div id="wrap">
        ...
        <section id="page-title">
            <div class="container clearfix">
                <h1>Place an Order (Document Translation)</h1>
                <nav id="breadcrumbs">
                    <ul>
                ...
                <form class="sky-form" action="" method="post" enctype="multipart/form-data">
                    <div class="panel panel-primary setup-content" id="step-1">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="form-group col-md-4 col-sm-6" id="div_tt" style="display:none;">
                            </div>
                            <div class="form-group col-md-4 col-sm-6" id="div_td" style="display:none;">
                            </div>
                    ...
                    <div class="panel panel-primary setup-content" id="step-5">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="form-group col-sm-5 dJob">
    ...
    <script type="text/javascript">
        ...
        $('.nextBtn:eq(0)').click(function() {
            ...
            if (!check_languages && source_language && target_language && docType) {
                set_language();
            }
        });
