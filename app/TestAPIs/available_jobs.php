    ...
    if(isset($_POST['ap_user_id']) && !empty($_POST['ap_user_id'])){
        ...
        }else
        {
            foreach ($json as $key => $job) {
                ...
                $ch = curl_init('https://lsuk.org/app/Jobs/AvailableJobs/view_job_details.php');
                ...
                $jobDetails = json_decode($response, true);
                $json[$key]['job_details'] = $jobDetails;
            }
