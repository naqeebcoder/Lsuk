        ...
        <form class="sky-form" action="#" method="post">
            <section id="content" class="container_fluid clearfix">
                <div class="col-lg-6">
                    ...
                    <div class="form-group col-md-6 col-sm-6" id="div_it" style="display:none;">
                    </div>
                    <div class="form-group col-md-8 col-sm-6" id="div_assignIssue" style="display:none;">
                    ...
                    <div class="form-group col-md-6 col-sm-6" title="System generated ID by LSUK">
                        ...
                        <input class="form-control" name="nameRef" type="text" required='' readonly="readonly" value="<?php
                                                                                                                        $month = date('M');
                    ...
                    <div class="bg-info col-xs-12 form-group">
                        <h4>Assignment Location (Enter Full Address)</h4>
                    </div>
                ...
                <div class="col-lg-6">
                    ...
                    <div class="form-group col-md-4 col-sm-6 hidden">
                        ...
                        <input class="form-control" name="orgName" id="orgName" type="text" value="<?php echo @$name_comp; ?>" placeholder='' readonly />
                    </div>
                    <div class="form-group col-md-4 col-sm-6 hidden">
                    ...
                    <div class="form-group col-md-4 col-sm-6 hidden">
                        ...
                        <input class="form-control" name="inchRoad" id="inchRoad" type="text" value="<?php echo isset($inchRoad) ? @$inchRoad : ""; ?>" placeholder='' readonly />
                    </div>
                    <div class="form-group col-md-4 col-sm-6 hidden">
                    ...
                    <div class="form-group col-sm-5">
                        ...
                        <div class="radio-inline ri"><label><input name="dbs_checked" type="radio" value="0" required checked="checked" />
                    ...
                    <div class="form-group col-sm-7">
                        ...
                        <div class="radio-inline ri"><label><input name="gender" type="radio" value="Male" required checked="checked" />
                    ...
                    <div class="form-group col-sm-7">
                        ...
                        <div class="radio-inline ri"><label><input name="jobDisp" type="radio" value="1" required checked />
