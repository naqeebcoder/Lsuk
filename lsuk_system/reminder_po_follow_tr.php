...
$query_reminder = $obj->read_all("translation.porder_email,translation.porder,translation.id,translation.orgName,translation.inchEmail,translation.inchPerson,translation.source,translation.target,translation.invoic_date,translation.asignDate as assignDate,translation.total_charges_comp,translation.cur_vat, translation.credit_note,translation.C_admnchargs,translation.nameRef,translation.orgRef,translation.invoiceNo", "(SELECT po_requested.order_id,MAX(dated) as latest_date FROM po_requested WHERE order_type='tr' GROUP BY order_id,order_type) as grp,translation,comp_reg", "translation.orgName=comp_reg.abrv and translation.multInv_flag=0 AND translation.deleted_flag = 0 and translation.order_cancel_flag=0 and translation.commit=1 and translation.total_charges_comp>0 and comp_reg.po_req=1 and (translation.porder='' OR translation.porder='Nil') and (round(translation.rAmount,2) < round((translation.total_charges_comp+(translation.total_charges_comp*translation.cur_vat)),2) or translation.total_charges_comp =0) and YEAR(translation.asignDate)>'2018' and grp.order_id=translation.id AND DATEDIFF(now(),grp.latest_date)>=7 LIMIT 30");
