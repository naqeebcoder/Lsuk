...
<body>
	...
	<section id="main" class="column"><!-- end of stats article -->
		<article class="module width_full">
			<header>
				<h3 class="tabs_involved" style="width:100px;"><a href="<?php echo basename(__FILE__); ?>"> PO Report</a></h3>
				<div align="center" style=" width:80%; margin-left:250px;margin-top:10px;">
					...
					|<select id="search_4" onChange="myFunction()" name="search_4" style="width:125px;height:25px;">
						<?php
						$sql_opt = "SELECT distinct comp_credit.porder, comp_credit.mode, comp_credit.credit from comp_credit
