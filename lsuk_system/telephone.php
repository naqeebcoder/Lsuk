    ...
    <div class="container-fluid">
        <form action="" method="post" class="register">
            ...
            <div class="form-group col-md-4 col-sm-6">
                ...
                <label class="new_company hidden" style="margin-top: 12px;"><input onchange="new_company_fields(this)" name="new_company_checkbox" id="new_company_register" class="new_company_checkbox" type="checkbox" value="1"> Register as new company</label>
            </div>
        ...
        $communicationOptions = [
            ...
            6 => 'WhatsApp Video',
            7 => 'Microsoft Teams',
            8 => 'Telephone Conference (Client + IP)',
            9 => 'Telephone Conferences (Client+IP+SU)',
            10 => 'Telephone Conference (International Destination)',
            11 => 'Other',
            12 => 'Attend Anywhere',
            13 => 'WhatsApp Audio',
        ];
        $comunictype=['7', '4', '5', '3', '2'];
        $comunicText = $communicationOptions[$_POST['comunic']] ?? 'Unknown';
        $assignByOptions = [
            1 => 'LSUK To Host',
            2 => 'Client To Host',
            3 => 'Client To Call LSUK',
        ];
        $hosted_by = $assignByOptions[$_POST['assign_by']] ?? 'Unknown';
        $hosted_by = "<li><strong>Hosted By: </strong> $hosted_by </li>";
        $listItems = "";
        if ($_POST['assign_by'] == 1) {
            if (in_array((string)$_POST['comunic'], $comunictype)) {
                $link = (!empty($_POST['communication_link']) ? $_POST['communication_link'] : 'Missing');
                $hosted_by = "";
                $listItems = "<li><strong>Communication Link:</strong>".$link."</li>";
            } else {
                $contactNo = $_POST['contactNo'] ?? 'nill';
                $inchContact = $_POST['noClient'] ?? 'nill';
                $listItems  = "<li><strong>Service User:</strong> {$contactNo}</li>";
                $listItems .= "<li><strong>Client Number:</strong> {$inchContact}</li>";
            }
        }else{
            $hosted_by="";
        }
        ...
        $serviceType = 'Remote ('.$comunicText.")";
        ...
        $email_formate = str_replace('<li><strong>Location:</strong> [Venue / Online Meeting Link]</li>', $hosted_by, $email_formate);
        ...
        $table="<style type='text/css'>
            ...
            " . $append_issue . "
            <tr>
            <td colspan='4' align='center' style='color: black;'>Contact Information</td>
            </tr>
            <tr>
        ...
        <script>
            $(document).ready(function() {
                ...
                $("#new_company_register").on("change", function() {
                    if (this.checked) {
