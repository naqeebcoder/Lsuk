...
<html lang="en">
<head>
<title><?php echo $page_title; ?> Business Credit List Trashed</title>
...
<div class="col-md-12">
		<header>
		    <div class="alert alert-danger col-md-3">
                <a href="<?php echo basename(__FILE__);?>" class="alert-link"> Business Credit List Trashed</a>
              </div>
         <div class="col-md-9">
...
<div class="">
	...
	$query=
	"SELECT  $table.id,$table.creditId,$table.mode,$table.invoiceNo,
		$table.orgName,$table.bz_credit,$table.bz_credit_date,$table.bz_debit ,$table.bz_debit_date,$table.dated 
	FROM $table
