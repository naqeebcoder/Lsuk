...
<head>
	<title>Income / Profit Statement - Accounts</title>
...
<body>
	...
	<section class="container-fluid" style="overflow-x:auto">
			...
			<center>
				<h2 class="col-md-4 col-md-offset-4 text-center m-b-50">
					<div class="label label-primary">
						<a href="<?php echo basename(__FILE__); ?>">Income / Profit Statement</a>
					</div>
				</h2>
			</center>
		</div>
		...
		<div class="col-md-12">
			...
			$total_records = $acttObj->read_specific("COUNT(*) AS total", "account_income", $conditions)['total'];
