...
<head>
	<title>View Expense Receipt</title>
...
include 'db.php';
$v_id = $_GET['v_id'];
$row_t = $acttObj->read_specific("id, voucher, invoice_no, exp_receipt", "expence", "id=" . $v_id);
$exp_r = "file_folder/expense_receipts/" . $row_t['exp_receipt'];
?>

<body>
	<div align="center" class="col-md-12"><br>
		<h1>Expense Receipt for voucher: <?php echo $row_t['voucher']; ?></h1><br />

		<?php
		if (file_exists($exp_r)) {
			$extensions = array("jpg", "jpeg", "png", "bmp", "webp");
			if (in_array(strtolower(end(explode(".", $exp_r))), $extensions)) { ?>
				<div class="col-md-12">
				...
				<br><br><br>
			<?php } else { ?>
				<iframe src="<?php echo $exp_r; ?>" frameborder='2' width="100%" height="100%"></iframe>
		<?php }
		} else {
