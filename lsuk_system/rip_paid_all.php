        ...
        <div class="col-md-12">
            <header>
                <center>
                    <h2 class="col-md-4 col-md-offset-4 text-center">
                        <div class="label label-primary"><a href="<?php echo basename(__FILE__);?>">Paid Invoices
                                Report</a></div>
                    </h2>
                </center>
            ...
            <div class="tab_container">
                <div id="tab1" class="tab_content" align="center">
                    ...
                    and translation.asignDate between '$search_2' and '$search_3' LIMIT {$limit}";
                    ?>
