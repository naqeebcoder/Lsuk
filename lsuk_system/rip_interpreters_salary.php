...
<html lang="en">
<head>
<title>Interpreters unpaid salaries list</title>
...
<div class="col-md-12">
<header>
		    <center><a href="<?php echo basename(__FILE__);?>"><h2 class="col-md-4 col-md-offset-4 text-center"><div class="alert bg-primary h4">INTEPRETERS SALARIES REPORT</div></h2></a></center>
