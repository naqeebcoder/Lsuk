...
<!-- end of sidebar -->
	...
	<section id="main" class="column"><!-- end of stats article -->
        ...
        <input type="date" name="search_3" id="search_3" placeholder='' style="border-radius: 5px;" onChange="myFunction()" value="<?php echo $search_3; ?>" />
                <a href="reports_lsuk/excel/<?php echo basename(__FILE__);?>?search_2=<?php echo $search_2; ?>&search_3=<?php echo $search_3; ?>" title="Download Excel Report">Excel</a>
		...
		<div class="tab_container">
			...
			<iframe height="1000px" width="950px" src="reports_lsuk/pdf/<?php echo basename(__FILE__);?>?search_2=<?php echo $search_2; ?>&search_3=<?php echo $search_3; ?>" ></iframe>
