...
while($row = mysqli_fetch_assoc($result)){$C_chargInterp=$row["C_chargInterp"] + $C_chargInterp;$C_otherCharges=$row["C_otherCharges"] + $C_otherCharges;$total_charges_comp=$row["total_charges_comp"] + $total_charges_comp;
