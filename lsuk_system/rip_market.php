...
<body>
	...
	<section id="main" class="column"><!-- end of stats article -->
		<article class="module width_full">
			<header>
				<h3 class="tabs_involved" style="width:200px;"><a href="<?php echo basename(__FILE__); ?>">General Report</a></h3>
				<div align="center" style=" width:60%; margin-left:400px;margin-top:10px;">
					<select id="search_1" name="search_1" style="width:125px;height:25px;" multiple="multiple">
						<?php
						$sql_opt = "SELECT distinct compType FROM comp_reg ORDER BY compType ASC";
						$result_opt = mysqli_query($con, $sql_opt);
						$options = "";
						while ($row_opt = mysqli_fetch_array($result_opt)) {
							$code = $row_opt["compType"];
							$name_opt = $row_opt["compType"];
