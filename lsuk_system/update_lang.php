...
?>
<?php include'db.php'; include'class.php';$table='interp_lang';$name=$_GET['name']; $reqcode=$_GET['code'];if(isset($_POST['submit'])){$edit_id= $acttObj->get_id($table);}?>
...
?>
      ...
      <!--
              ...
              <?php if(isset($_POST['submit'])){$c3=$_POST['source'];$acttObj->editFun($table,$edit_id,'code',$reqcode);$acttObj->editFun($table,$edit_id,'lang',$c3);} ?>
            </p>
          </fieldset>
