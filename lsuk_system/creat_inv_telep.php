...
function myFunction() {
	 ...
	 window.location.href="creat_inv_telep.php" + '?interp=' + x + '&org=' + y + '&job=' + z + '&assignDate=' + w;
...
<!-- end of sidebar -->
	...
	<section id="main" class="column"><!-- end of stats article -->
				<article class="module width_full">
				  <header>
				    <h3 class="tabs_involved" style="width:285px;">single Telephone Interp invoice</h3>
...
?>
			...
			while($row = mysqli_fetch_array($result)){?>            
				<tr>
				  <td><?php echo $row['source']; ?></td>
                    ...
                    <a href="#" onClick="MM_openBrWindow('del.php?del_id=<?php echo $row['id']; ?>&table=<?php echo $table; ?>','_blank','scrollbars=yes,resizable=yes,width=400,height=200')"><input type="image" src="images/icn_trash.png" title="Trash">
                    <?php } ?>
                    </a>
                    
                    <?php if($row['total_charges_interp']==NULL || $row['total_charges_interp']==0 || $_SESSION['prv']=='Management'){ ?> <a href="#" onClick="MM_openBrWindow('telep_expanses.php?update_id=<?php echo $row['id']; ?>','_blank','scrollbars=yes,resizable=yes,width=900,height=650')"><input type="image" src="images/Update.png" title="Update Expanses"></a><?php } ?>
              <?php if($row['multInv_flag']==0){ ?>       
                     <a href="#" onClick="MM_openBrWindow('telep_invoice.php?invoice_id=<?php echo $row['id']; ?>','_blank','scrollbars=yes,resizable=yes,width=900,height=650')"><input type="image" src="images/invoice.png" title="Invoice"></a><?php } ?>
  ...
  <?php }} ?>
                   ...
                   <?php if($row['total_charges_comp']==NULL || $row['total_charges_comp']==0 || $_SESSION['prv']=='Management'){ ?> <a href="#" onClick="MM_openBrWindow('co_telep_expanses.php?update_id=<?php echo $row['id']; ?>','_blank','scrollbars=yes,resizable=yes,width=900,height=650')"><input type="image" src="images/company-icon.jpg" title="Comp Update Expanses"> </a><?php } ?>
                    <?php if($_SESSION['prv']=='Management'){?>
