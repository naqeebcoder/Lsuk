...
?>
<link rel="stylesheet" type="text/css" href="wp-content/themes/freshlife_americablog/layout.css" /><br /><br /><br />
...
<form action="" method="post"enctype="multipart/form-data">
 <input name="<?php echo $col; ?>" type="text" class="long" id="<?php echo $col; ?>" style="border:1px solid #CCC" placeholder='' value="<?php echo $data; ?>" <?php if(!empty($pattern)){?> pattern="<?php echo $pattern; ?>" <?php } ?> required /><br/><br/>
