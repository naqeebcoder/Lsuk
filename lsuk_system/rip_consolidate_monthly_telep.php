...
<?php include 'db.php';include 'class.php';$search_1=@$_GET['search_1']; $search_2=@$_GET['search_2'];$year=2014;	?>
...
<!-- end of sidebar -->
	...
	<section id="main" class="column"><!-- end of stats article -->
		...
		<header><h3 class="tabs_involved" style="width:300px;"><a href="<?php echo basename(__FILE__);?>">Consolidate Month Wise Report (Telep)</a></h3>
...
?>
         ...
         <select id="search_2" name="search_2" onChange="myFunction()">
		    		<option><?php if($search_2){echo $search_2;}else{echo '..Select Year..';} ?></option>
                    <?php while($year<=2020){ ?>
