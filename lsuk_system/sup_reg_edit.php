...
include 'db.php';
include 'class.php';
$allowed_type_idz = "103";
//Check if user has current action allowed
if ($_SESSION['is_root'] == 0) {
  $get_page_access = $acttObj->read_specific("id", "action_permissions", "user_id=" . $_SESSION['userId'] . " AND action_id IN (" . $allowed_type_idz . ")")['id'];
  if (empty($get_page_access)) {
    die("<center><h2 class='text-center text-danger'>You do not have access to <u>Edit Supplier</u> action!<br>Kindly contact admin for further process.</h2></center>");
  }
}
$table = 'sup_reg';
  ...
  <div class="container-fluid">
    <form action="" method="post" class="register" enctype="multipart/form-data">
      <div style="background: #8c8c86;padding: 6px;position: fixed;z-index: 999999999999;width: 100%;color: white;">
        ...
        <button class="btn btn-info pull-right" style="border-color: #000000;color: black;text-transform: uppercase;margin: 7px 21px;font-size: 16px;font-weight: bold;box-shadow: 2px 2px 2px #c5c5a3;" type="submit" name="submit">UPDATE SUPPLIER &raquo;</button>
      </div><br><br><br><br>
      <div class="form-group col-md-3 col-sm-6">
        <input placeholder="Supplier Name *" name="sp_name" class="form-control " type="text" id="sp_name" onchange="uniqueFun(this.value,'sup_reg','sp_name',$(this).attr('id') );" onBlur="uniqueFun($('#sp_abrv').val(),'sup_reg','abrv',$('#sp_abrv').attr('id') );" oninput="short_name();" value="<?php echo $sp_name; ?>" required />
      </div>
      <div class="form-group col-md-3 col-sm-6">
        <input placeholder="Abrivaiton of Supplier  *" name="sp_abrv" class="form-control " type="text" id="sp_abrv" value='<?php echo $sp_abrv; ?>' />
      </div>
      <div class="form-group col-md-3 col-sm-6">
        <input name="sp_rnum" type="text" id="sp_rnum" class="form-control" placeholder="Supplier Registration Number" value='<?php echo $sp_rnum; ?>' />
      </div>
      <!-- <div class="form-group col-md-3 col-sm-6">
        <input placeholder="Supplier Code" name="sp_code" type="text" id="sp_code" class="form-control" />
      </div> -->
      <div class="form-group col-md-3 col-sm-6">
        <input placeholder="Supplier Contact *" name="sp_contact" class="form-control " type="text" id="sp_contact" value='<?php echo $sp_contact; ?>' />
      </div>
      <div class="form-group col-md-3 col-sm-6">
        <input name="sp_email" type="text" id="sp_email" class="form-control" placeholder="Supplier Email Address *" value='<?php echo $sp_email; ?>' />
      </div>
      <div class="form-group col-md-3 col-sm-6">
        <input name="sp_type" type="text" id="sp_type" class="form-control" placeholder="Supplier Type" value='<?php echo $sp_type; ?>' />
      </div>
      <div class="form-group col-md-3 col-sm-6">
        <input name="sp_web" type="text" id="sp_web" class="form-control" placeholder="Supplier Website" value='<?php echo $sp_web; ?>' />
      </div>
      ...
      <div class="form-group col-md-3 col-sm-4">
        ...
        <input onchange="if(this.checked) {$('#tax_details').removeClass('hidden');}else{$('#tax_details').addClass('hidden');}" type="checkbox" id="tax_reg" name="tax_reg" value="1" data-toggle="toggle" data-on="Yes" data-off="No" <?php if ($tax_reg == 1) {
                                                                                                                                                                                                                                          echo "checked";
                                                                                                                                                                                                                                        } ?>>

      </div>
      <div id="tax_details" class="<?php if ($tax_reg == 0) {
                                      echo "hidden";
                                    } ?>">
        <div class="form-group col-md-3 col-sm-4">
          <label>
            <b>UK Citizen ?</b></label><br>
          <input onchange="if(this.checked) {$('#div_uk_citizen_vatNum').removeClass('hidden');$('#div_country_vat').addClass('hidden');$('#div_country_vatNum').addClass('hidden');}else{$('#div_uk_citizen_vatNum').addClass('hidden');$('#div_country_vat').removeClass('hidden');$('#div_country_vatNum').removeClass('hidden');}" type="checkbox" id="uk_citizen" name="uk_citizen" value="1" data-toggle="toggle" data-on="Yes" data-off="No" <?php if ($uk_citizen == 1) {
                                                                                                                                                                                                                                                                                                                                                                                                                                                      echo "checked";
                                                                                                                                                                                                                                                                                                                                                                                                                                                    } ?>>
        ...
        <div class="form-group col-md-3 col-sm-4 " id="div_uk_citizen_vatNum">
          ...
          <input name="uk_citizen_vatNum" type="text" id="uk_citizen_vatNum" class="form-control" placeholder="Enter UK VAT Number" value='<?php echo $uk_citizen_vatNum; ?>' />
        </div>
        ...
        <option value='' disabled selected>Select a country</option>";
          foreach ($country_array as $key => $val) {
            $select_countries .= "<option value='" . $key . "' " . ($country_vat == $key ? 'selected' : '') . ">" . $val . "</option>";
          }
        ...
        <div class="form-group col-md-3 col-sm-4 hidden" id="div_country_vatNum">
          ...
          <input name="country_vatNum" type="text" id="country_vatNum" class="form-control" placeholder="TAX Number" value='<?php echo $country_vatNum; ?>' />
        </div>
      </div>
...
<input name="aupn" type="text" placeholder='' required />
      ...
      <div class="form-group col-md-3">
        ...
        foreach ($country_array as $key => $val) {
          $select_countries .= "<option value='" . $key . "' " . ($sp_country == $key ? 'selected' : '') . ">" . $val . "</option>";
        }
        $select_countries .= "<select>";
        echo $select_countries; ?>
      </div>
      ...
      <div class="form-group col-md-3 div_other_city_field hidden">
        ...
        <input name="sp_city" type="text" class="form-control mt other_city_field hidden" placeholder="Enter City Name" value='<?php echo $sp_city; ?>' />
      </div>
      <div class="form-group col-md-3 col-sm-6">
        <label>Post Code</label>
        <input name="sp_postCode" type="text" class="form-control" placeholder="Post Code" value='<?php echo $sp_postCode; ?>' />
      </div>
      <div class="form-group col-md-3 col-sm-6">
        <label>Building Number / Name</label>
        <input name="sp_buildingName" type="text" class="form-control" placeholder="Building Number / Name" value='<?php echo $sp_buildingName; ?>' />
      </div>
      <div class="form-group col-md-3 col-sm-6">
        <label>Street / Road</label>
        <input name="sp_streetRoad" type="text" class="form-control" placeholder="Address Line 3" value='<?php echo $sp_streetRoad; ?>' />
      </div>
      <div class="form-group col-md-3 col-sm-6">
        <label>Address Line 1</label>
        <input name="sp_line1" type="text" class="form-control" placeholder="Address Line 1" value='<?php echo $sp_line1; ?>' />
      </div>
      <div class="form-group col-md-3 col-sm-6">
        <label>Address Line 2</label>
        <input name="sp_line2" type="text" class="form-control" placeholder="Address Line 2" value='<?php echo $sp_line2; ?>' />
      </div>

      <!-- <div class="form-group col-md-3 col-sm-6">
        <label>Invoicing Email Address</label>
        <input name="invEmail" type="text" id="invEmail" class="form-control"  placeholder="Invoicing Email Address" />
      </div> -->
      <!-- <p>
                  <label class="optional">Company Invoicing Address 
           	  </label>
                  <input name="invAddrs" type="text"   />
      ...
      <div class="form-group col-md-3 col-sm-6">
        <input class="form-control " name="sp_bnkName" type="text" id="sp_bnkName" placeholder="Bank Name" value='<?php echo $sp_bnkName; ?>' />
      </div>
      <div class="form-group col-md-3 col-sm-6">
        <input class="form-control " name="sp_acName" type="text" id="sp_acName" placeholder="Account Holder Name" value='<?php echo $sp_acName; ?>' />
      </div>
      <div class="form-group col-md-3 col-sm-6">
        <input type="text" class="form-control" name="account_number" id="acNo" oninput="this.value = this.value.replace(/[^0-9-.]/g, '').replace(/(\..*)\./g, '$1');" maxlength="8" minlength="8" placeholder="Enter Account Number (8 digits)" value='<?php echo $sp_acName; ?>'>
      </div>
      <div class="form-group col-md-3 col-sm-6">
        <input type="text" class="form-control" name="sort_code" id="acntCode" oninput="this.value = this.value.replace(/[^0-9-.]/g, '').replace(/(\..*)\./g, '$1');" maxlength="8" minlength="8" placeholder="Enter Sort Code (6 digits)" value='<?php echo $sp_acNum; ?>'>
      </div>
      ...
      <div class="form-group col-md-3 col-sm-6">
        <input placeholder="Contact Person Name *" name="sp_cpName" class="form-control " type="text" id="sp_cpName" value='<?php echo $sp_cpName; ?>' />
      </div>
      <div class="form-group col-md-3 col-sm-6">
        <input placeholder="Position in Business" name="sp_cppos" class="form-control " type="text" id="sp_cppos" value='<?php echo $sp_cppos; ?>' />
      </div>
      <div class="form-group col-md-3 col-sm-6">
        <input placeholder="Contact *" name="sp_cpNum" class="form-control " type="text" id="sp_cpNum" value='<?php echo $sp_cpNum; ?>' />
      </div>
      <div class="form-group col-md-3 col-sm-6">
        <input name="sp_cpEmail" type="text" id="sp_cpEmail" class="form-control" placeholder="Email Address *" value='<?php echo $sp_cpEmail; ?>' />
      </div>
    </form>
  </div>
...
if (isset($_POST['submit'])) {
  ...
  // $acttObj->editFun($table, $edit_id, 'sp_code', $sp_code);
  ...
  echo "<script>alert('Supplier edited successfully.');</script>";
