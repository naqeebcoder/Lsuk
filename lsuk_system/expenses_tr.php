...
if (isset($_POST['btn_submit_expense'])) {
    ...
    $total = (($numberUnit * $rpU) + $otherCharg) - $deduction;
    ...
    <?php } else { ?>
        <table class="table table-bordered">
            <tbody>
                ...
                <tr>
                    <td>Timesheet Updated VIA : <?php echo $numberUnit == 0 ? 'Not Updated' : $array_added_via[$row['added_via']];
                ...
                <div class="col-md-12">
                    <form action="" method="post" class="register">
                        ...
                        <div class="bg-info col-xs-12 form-group">
                            <h4>Fixed Rate or Per <?php echo $trans_single_label; ?> Rate (As Agreed) Booking Type:
