...
function myFunction() {
	 ...
	 window.location.href="interp_list_multip.php" + '?interp=' + x + '&org=' + y + '&job=' + z + '&assignDate=' + w + '&our=' + p + '&ur=' + q + '&inov=' + o;
...
<!-- end of sidebar -->
	...
	<section id="main" class="column"><!-- end of stats article -->
		...
		<header><h3 class="tabs_involved" style="width:200px;"><a href="<?php echo basename(__FILE__);?>">Interpreter booking list</a></h3>
...
?>
  ...
  <input type="date" name="assignDate" id="assignDate" placeholder='' style="width:100px;border-radius: 5px;" onChange="myFunction()" value="<?php echo $assignDate; ?>"/>
	  ...
	  switch($_SESSION['prv']){
	   ...
	   where $table.deleted_flag = 0 and $table.order_cancel_flag=0 and $table.assignDate like '$assignDate%' and $table.multInv_flag=1 and source like '$job%' and interpreter_reg.name like '%$interp%' and $table.orgName like '%$org%' and $table.nameRef like '%$our%' and $table.orgRef like '%$ur%' and $table.invoiceNo like '%$inov%'
...
<a href="#" onClick="MM_openBrWindow('interp_edit.php?edit_id=<?php echo $row['id']; ?>&duplicate=<?php echo 'yes'; ?>','_blank','scrollbars=yes,resizable=yes,width=900,height=650')"><input type="image" src="images/commit.png" title="Create Duplicate"></a>
    				  <?php if($_SESSION['prv']=='Management' || $_SESSION['prv']=='Operator'){?>
                      
                    <?php if($_SESSION['prv']=='Management'){?>
<a href="#" onClick="MM_openBrWindow('interp_edit.php?edit_id=<?php echo $row['id']; ?>','_blank','scrollbars=yes,resizable=yes,width=900,height=650')"><input type="image" src="images/icn_edit.png" title="Edit"></a>
<?php }if($_SESSION['prv']=='Management'){?>
<a href="#" onClick="MM_openBrWindow('interp_assign.php?assign_id=<?php echo $row['id']; ?>&table=<?php echo $table; ?>&srcLang=<?php echo $row['source']; ?>','_blank','scrollbars=yes,resizable=yes,width=900,height=650')"><input type="image" src="images/icn_add_user.png" title="Edit Assign Interpreter"></a>
<?php } ?>


                    <?php }if($_SESSION['prv']=='Management'){?>
                    <a href="#" onClick="MM_openBrWindow('email_emend.php?email_id=<?php echo $row['id']; ?>&table=<?php echo $table; ?>&col=intrpName','_blank','scrollbars=yes,resizable=yes,width=400,height=200')"><input type="image" src="images/icn_jump_back.png" title="Go Home Screen"></a>
...
<a href="#" onClick="MM_openBrWindow('update_expanses.php?update_id=<?php echo $row['id']; ?>','_blank','scrollbars=yes,resizable=yes,width=900,height=650')"><input type="image" src="images/Update.png" title="Update Expanses"></a>
...
<a href="#" onClick="MM_openBrWindow('comp_interp_credit_note.php?update_id=<?php echo $row['id']; ?>','_blank','scrollbars=yes,resizable=yes,width=900,height=650')"><input type="image" src="images/icn_settings.png".png" title="Make Credit Note"></a>

<?php if($row['credit_note']){ ?>
<a href="#" onClick="MM_openBrWindow('credit_interp.php?invoice_id=<?php echo $row['id']; ?>','_blank','scrollbars=yes,resizable=yes,width=900,height=650')"><input type="image" src="images/icn_categories.png" title="Credit Note"></a>
                    <?php }}if($_SESSION['prv']=='Management' || $_SESSION['prv']=='Finance' ){?>
...
<a href="#" onClick="MM_openBrWindow('email_resume.php?email_id=<?php echo $row['id']; ?>&table=<?php echo $table; ?>','_blank','scrollbars=yes,resizable=yes,width=400,height=200')"><input type="image" src="images/icn_alert_error.png" title="Order Canceled"></a>
  ...
  <?php }} ?>
                    <?php if($_SESSION['prv']=='Management' || $_SESSION['prv']=='Finance' ){?>
<a href="#" onClick="MM_openBrWindow('co_update_expanses.php?update_id=<?php echo $row['id']; ?>','_blank','scrollbars=yes,resizable=yes,width=900,height=650')"><input type="image" src="images/company-icon.jpg" title="Comp Update Expanses"></a>
...
<a href="#" onClick="MM_openBrWindow('comp_earning.php?view_id=<?php echo $row['id']; ?>','_blank','scrollbars=yes,resizable=yes,width=900,height=650')"><input type="image" src="images/earning.png" title="Earning">
</a>                    <?php } ?>
                    </td> 
				</tr> 
                <?php } ?>
