...
<!-- end of sidebar -->
	...
	<section id="main" class="column"><!-- end of stats article -->
		...
		<header><h3 class="tabs_involved" style="width:200px;">Interpreter <span class="tabs_involved" style="width:300px;">Due Date</span> list</h3>
...
?>
    ...
    <?php echo $options; ?>
	  ...
	  if(!empty($org) || !empty($interp) || !empty($job)){
	   ...
	   order by dueDate LIMIT {$startpoint} , {$limit}";	}
			...
			while($row = mysqli_fetch_array($result)){?>            
				<tr>
				  <td><?php echo $row['source']; ?></td>
    				...
    				<td><?php echo date_format(date_create($row['assignTime']), 'd-m-Y'); ?></td>
   				</tr> 
                <?php } ?>
                </tbody></table>                
