...
<!-- end of sidebar -->
	...
	<section id="main" class="column"><!-- end of stats article -->
		...
		<header><h3 class="tabs_involved" style="width:200px;">General Report</h3>
...
?>
		...
		<div class="tab_container">
			...
			<iframe height="1000px" width="950px" src="pdf_script/pdf_new/examples/example_048.php" ></iframe>
