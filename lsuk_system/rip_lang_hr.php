...
<html lang="en">
<head>
<title>Interpreters language (hours) summary</title>
...
<div class="col-md-12">
<header>
		    <center><a href="<?php echo basename(__FILE__);?>"><h2 class="col-md-4 col-md-offset-4 text-center"><div class="alert bg-primary h4">Language (hours) summary report</div></h2></a></center>
   <div class="col-md-12"><br>
             <div class="form-group col-md-2 col-sm-3 col-md-offset-1">
                <select id="search_1" name="search_1" class="form-control">
		      <?php 			
