...
function myFunction() {
	 ...
	 window.location.href="telep_paid.php" + '?interp=' + x + '&org=' + y + '&job=' + z + '&assignDate=' + w + '&our=' + p+ '&ur=' + q + '&inov=' + o;
...
<!-- end of sidebar -->
	...
	<section id="main" class="column"><!-- end of stats article -->
		...
		<header>
		  <h3 class="tabs_involved" style="width:300px;"><a href="<?php echo basename(__FILE__);?>">Telep Paid List</a> Sum Received: £(<span id="lblTotalPrice"></span>)</h3>
...
where (orgName like '%$_words%') and telephone.multInv_flag=0 and telephone.commit=1 and (total_charges_comp <= rAmount)";
...
where telephone.multInv_flag=0 and telephone.commit=1 and (total_charges_comp <= rAmount)
