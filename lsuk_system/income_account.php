...
<head>
    <title><?php echo $page_title; ?> Income Account</title>
            ...
            <header>
                <div class="row">
                    <center><a href="<?php echo basename(__FILE__); ?>">
                            <h2 class="col-md-4 col-md-offset-4 text-center" style="margin-bottom: 2rem;"><span class="label label-primary">Income Account</span></h2>
                        </a></center>
                </div>
