...
<html lang="en">
<head>
<title><?php echo $page_title; ?> Credit List Full Trashed</title>
<link rel="stylesheet" type="text/css" href="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/css/bootstrap.min.css" />
</head>
<script>
function myFunction() {
	 var y = document.getElementById("org").value;if(!y){y="<?php echo $org; ?>";}
	 window.location.href="<?php echo basename(__FILE__);?>" + '?org=' + y ;
...
<div class="col-md-12">
		<header>
		    <div class="alert alert-danger col-md-3">
                <a href="<?php echo basename(__FILE__);?>" class="alert-link"> Credit List Full Trashed</a>
              </div>
         <div class="col-md-9">
...
?>
		...
		<div class="">
			...
			<tbody> 
      <?php $table='comp_credit';
	   $query=
	   "SELECT  $table.id,$table.porder,$table.mode,$table.invoiceNo,$table.orgName,$table.credit,
	   	$table.credit_date,$table.debit debit,$table.debit_date,$table.dated 
	   FROM $table
	   LEFT JOIN comp_reg ON $table.orgName=comp_reg.abrv
	   where $table.deleted_flag=1 and $table.orgName like '$org%'
