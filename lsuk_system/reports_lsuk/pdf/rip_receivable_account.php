            ...
            <div>
                <div>
                    <table class="table table-bordered table-hover" cellspacing="0" width="100%">
                        ...
                        <tbody>
                            <?php
                            $fetch_jobs = $acttObj->read_all("id,voucher,dated,company,description,credit,debit,balance,deleted_flag","account_receivable"," deleted_flag=0 ".(!empty($search2)?" AND dated BETWEEN '$search2' AND '$search3' ":"")." LIMIT {$startpoint} , {$limit} ");
