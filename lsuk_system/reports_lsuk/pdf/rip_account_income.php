...
$query="SELECT id,voucher,dated,company,description,credit,debit,balance,deleted_flag FROM account_income where deleted_flag=0 ".(!empty($search_2)?" AND dated BETWEEN '$search_2' AND '$search_3' ":"")." LIMIT {$startpoint} , {$limit}";
...
$tbl .= <<<EOD
<div>
<h2 align="center"><u>Income Account</u></h2>
