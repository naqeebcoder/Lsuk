...
$total_reg_paid=$row_pd['total_reg_paid'];
...
$total_reg_pend=$row_pe['total_reg_pend'];
...
// $total_invoices=$total_reg_paid+$total_reg_pend;
...
<p align="right">Report  Date: <?php echo $misc->sys_date(); ?><br />
  Date  Range: Date From [<?php echo $misc->dated($search_2); ?>] Date To [<?php echo $misc->dated($search_3); ?>]</p>
...
<tr>
    ...
    <td></td>
    <th><?php echo $net_total_pd; ?></th>
    <td></td>
</tr>
<tr>
    <td></td>
    <td>Total Pending invoices</td>
    <th><?php echo $pend_i; ?></th>
    <td></td>
    <td></td>
</tr>
<tr>
    ...
    <td></td>
    <th><?php echo $net_total_pe; ?></th>
    <td></td>
</tr>
<tr>
    <td></td>
    <td>Credit Notes </td>
    <td><?php echo $credit_notes; ?></td>
    <th><?php echo ($total_credit_note_charges>0?"-".$total_credit_note_charges:$total_credit_note_charges); ?></th>
    <td></td>
</tr>
<tr style="border-bottom: 3px solid #000000;">
    ...
    <td></td>
    <td></td>
    <th><?php echo $net_total." (Non-VAT = ".$C_otherCharg.")"; ?></th>
</tr>
<tr>
...
<tr class="bg-info" style="border-top: 3px solid #000000;border-bottom: 3px solid #000000;">
    ...
    <td></td>
    <td></td>
    <th><?php echo  $net_total+$rental_income;?></th>
</tr>
<tr>
    <th>VAT</th>
    <td></td>
...
<tr>
    ...
    <td></td>
    <th><?php echo $vat_rental_income; ?></th>
    <td></td>
</tr>
<tr>
    <td></td>
    <td>VAT Paid on supplier invoices</td>
    <td><?php echo $count_vat_sp; ?></td>
    <th><?php echo '-'.$vat_sp_inv; ?></th>
    <td></td>
</tr>
<tr>
    <td></td>
    <td>VAT reversal on credit notes </td>
    <td></td>
    <th><?php echo '-'.$total_credit_note_vat; ?></th>
    <td></td>
</tr>
<tr>
    <td></td>
    <td>VAT reversal on bad debt </td>
    <td></td>
    <th><?php echo '-'.$net_vat_bad_debt; ?></th>
    <td></td>
</tr>
<tr  style="border-bottom: 3px solid #000000;">
    <th>Total VAT</th>
...
<tr  style="border-top: 3px solid #000000;border-bottom: 3px solid #000000;">
    ...
    <td></td>
    <td></td>
    <th><?php echo ($tot_revenue_after_vat = $net_total+$rental_income-$tot_fvat); ?></th>
</tr>
<tr>
    <th>Cost of Sales</th>
    <td></td>
...
<tr>
    ...
    <td></td>
    <th><?php echo $payment_to_interpreters; ?></th>
    <td></td>
</tr>
<tr style="border-bottom: 3px solid #000000;">
...
<tr style="border-bottom: 3px solid #000000;">
    ...
    <td></td>
    <td></td>
    <th><?php echo $tot_revenue=$tot_revenue_after_vat-$payment_to_interpreters; ?></th>
</tr>
<tr>
    <th>Expenses</th>
    <td></td>
...
<tr>
    ...
    <td></td>
    <th><?php echo $stf_trn_dev_exp; ?></th>
    <td></td>
</tr>
<tr>
    <td></td>
...
<tr>
    ...
    <td></td>
    <th><?php echo $computing_costs_exp; ?></th>
    <td></td>
</tr>
<tr>
    <td></td>
    <td>Admin Cost</td>
    <td></td>
    <th><?php echo $admin_costs_exp; ?></th>
    <td></td>
</tr>
<tr>
    <td></td>
...
<tr>
    ...
    <td></td>
    <th><?php echo $transport_expenses; ?></th>
    <td></td>
</tr>
...
<tr>
    ...
    <td></td>
    <th><?php echo $sub_contractor_exp; ?></th>
    <td></td>
</tr>
<tr>
    <td></td>
...
<tr>
    ...
    <td>Utility bills</td>
    <td></td>
    <th><?php echo $utility_bills_exp; ?></th>
    <td></td>
</tr>
<tr>
    <td></td>
    ...
    <td></td>
    <th><?php echo $prof_fee_exp; ?></th>
    <td></td>
</tr>
<tr>
    <td></td>
    <td>Bad debt </td>
    <td><?php echo $bad_debt_count; ?></td>
    <th><?php echo $bad_debt_amount; ?></th>
    <td></td>
</tr>
<tr>
    <td></td>
...
<tr class="bg-info">
    ...
    <td></td>
    <td></td>
    <th><?php echo $pr_bf_taxes = $tot_revenue-$total_expnce; ?></th>
</tr>
</tbody>
</table>
...
<tbody>
<tr style="margin-top:5rem;border-top: 3px solid #000000; border-bottom: 3px solid #000000;">
...
<tr style="border-top: 3px solid #000000; border-bottom: 3px solid #000000;">
    ...
    <td></td>
    <td></td>
    <th><?php echo $tot_forbidden_expenses; ?></th>
</tr>
</tbody>
</table>