...
$signature="";
$red_line="";
$query = "SELECT $table.*, interpreter_reg.name, interpreter_reg.email as int_email, comp_reg.name as orgName  FROM $table
...
if($row['intrpName']==$user_id && (!is_null($user_id) && !empty($user_id))){
    $source = $row['source'];
    $target = $row['target'];
...
<div style="font-size:12px"><span style="font-weight:bold;color:#066;">Client Name or Ref:</span> <u>'.$orgRef.' </u> <span style="color:#FFF; font-size:7px"></span><span style="font-weight:bold;color:#066;"> Date: </span><u>'.$misc->dated($assignDate).'</u><span style="color:#FFF; font-size:7px">_</span>  <span style="font-weight:bold;color:#066;"> Time:</span> <u>'.$assignTime.'</u><span style="font-weight:bold;color:#000;font-size:7px"> PM/AM</span> <span style="font-size:7px">________</span></div>
...
<div style="font-size:12px"><span style="font-weight:bold;color:#066;">Date of Assignment: </span><u>'.$misc->dated($assignDate).'  </u><span style="color:#FFF; font-size:7px">_________</span><span style="font-weight:bold;color:#066;">Time of Assignment:</span> <u>'.$assignTime.'</u><span style="font-weight:bold;color:#066">&nbsp;&nbsp;&nbsp;&nbsp;Service User Name:</span><u>&nbsp;&nbsp;&nbsp;'.$orgContact.'&nbsp;&nbsp;</u>&nbsp;<br></div>
