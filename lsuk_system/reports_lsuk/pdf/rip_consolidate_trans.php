...
<?php include '../../db.php';include_once ('../../class.php'); $excel=@$_GET['excel'];$search_1=$_GET['search_1'];$search_2=@$_GET['search_2'];$search_3=@$_GET['search_3'];$counter=0;$x=0; $source_num=0;$org='';
...
<table class="aa" border="1" cellspacing="0" cellpadding="0" style="width:250px">
  ...
  <?php $query="SELECT distinct (translation.source) FROM translation						
