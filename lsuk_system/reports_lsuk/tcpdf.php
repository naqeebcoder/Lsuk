...
class TCPDF {
	...
	public function Footer() {
		...
		if ($this->getRTL()) {
			...
			$this->SetX($this->original_lMargin);
			$this->Cell(0, 0, 'Language Services UK Limited and LSUK Limited are trading names of LanguageServicesUK Limited registers in England and Wales (7760366),VAT # 198427362', 'T', 0, 'C');
			$this->Ln();
			$this->Cell(0, 0, 'Trading Address: Suite 3 Davis House Lodge Causeway Trading Estate Lodge Causeway - Fishponds Bristol BS163JB Tel: 01173290610', 'T', 0, 'C');
