...
<div>
<h2 align="center"><u>Telephone Interpreting General Report ('.$search_1.')</u></h2>
...
{
	$C_chargInterp=$row["C_chargInterp"] + $C_chargInterp;$C_otherCharges=$row["C_otherCharges"] + $C_otherCharges;
...
$htmlTable .='<td>'.$i.'</td>';
		...
		$htmlTable .='<td>'.$misc->dated($row["assignDate"]).'<br/>'.$row['assignTime'].'</td>';
...
$htmlTable .='<td>'.$misc->numberFormat_fun($C_chargInterp).'</td>';	
$htmlTable .='<td>'.$misc->numberFormat_fun($C_otherCharges).'</td>';	
