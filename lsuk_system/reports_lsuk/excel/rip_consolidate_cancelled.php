...
$htmlTable .='<h2 style="text-decoration:underline; text-align:center">Consolidate Order Cancelation Report(Interpreter)</h2>
<p>Face to Face Interpreting<br/>Date Range:' .$search_2. '</p>
</div>
...
$htmlTable.='<th>'.date('F', mktime(0, 0, 0, $assignDate, 10)).'</th>';
$counter++;}
$htmlTable.='</tr>';
