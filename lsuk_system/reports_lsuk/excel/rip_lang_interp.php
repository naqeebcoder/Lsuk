...
$htmlTable .='<h2 style="text-decoration:underline; text-align:center">Language Report from "Face to Face" Interpreter</h2>
...
<tr>
    ...
    <th style="background-color:#039;color:#FFF;">Job Location</th>
