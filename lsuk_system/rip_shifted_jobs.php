...
<head>
    <title>Shifted Jobs Report </title>
        ...
        <div class="col-md-12">
            <header>
                <center>
                    <h2 class="col-md-4 col-md-offset-4 text-center">
                        <div class="label label-primary"><a href="<?php echo basename(__FILE__);?>">Shifted Jobs Report</a></div>
                    </h2>
                </center>
            ...
            <div class="tab_container">
                <div id="tab1" class="tab_content" align="center">
                    <?php
                    $query="SELECT interpreter.id,interpreter.nameRef,interpreter.orgName,interpreter.orgRef,interpreter.invoiceNo,interpreter.assignDate,interpreter.source,'F2F' as job_type FROM interpreter WHERE interpreter.assignDate between '$search_2' and '$search_3' AND interpreter.is_shifted = 1 
                    UNION ALL
                    SELECT telephone.id,telephone.nameRef,telephone.orgName,telephone.orgRef,telephone.invoiceNo,telephone.assignDate,telephone.source,'Telephone' as job_type FROM telephone WHERE telephone.assignDate between '$search_2' and '$search_3' AND telephone.is_shifted = 1  LIMIT {$limit}";
                    ?>
