                    ...
                    <div id="int_documents" class="tab-pane fade">
                        ...
                        <form class="register col-md-12" action="javascript:void(0);">
                            <table width="50%" class="table table-bordered table-hover">
                                ...
                                <?php endif; ?>
                                <?php if($row['country_of_origin'] == ''): ?>
                                <tr>
                                    <td>Country Of Orgin<label class="label label-danger pull-right"><b>Not Provided</label></b></td>
                                    <td><span style="color:red;">Missing</span></td>
                                    <td><button type="button" 
                                            onclick="window.open('interp_reg_edit.php?edit_id=<?php echo $view_id ?>',
                                                                'popupWindow',
