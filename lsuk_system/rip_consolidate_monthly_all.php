...
$test = date_create($search_2);
if ($search_2 == "" || $test == false)
	$search_2 = $misc->sys_date();
...
<body>
	...
	<section id="main" class="column"><!-- end of stats article -->
		<article class="module width_full">
			<header>
				<h3 class="tabs_involved" style="width:300px;"><a href="<?php echo basename(__FILE__); ?>">Consolidate Month Wise Report (All)</a></h3>
