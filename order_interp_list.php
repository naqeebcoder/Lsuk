...
<?php include'source/top_nav.php'; ?>
    ...
    <section id="content" class="container clearfix">
        	            <!-- begin table -->
            <section>
            	<h2>Face to Face Orders List</h2>
                <table class="gen-table">
                    ...
                    <thead>
                      ...
                      <tbody>
 <?php $table='interpreter'; $cust_userId= $_SESSION['cust_userId']; 
 		$query="SELECT $table.orgName,$table.source,$table.assignDate,$table.assignTime FROM $table
	   	JOIN  comp_add_frm_web ON $table.orgName=comp_add_frm_web.orgName
	   	where  $table.deleted_flag=0 and $table.order_cancel_flag=0 and comp_add_frm_web.user_code=$cust_userId order by assignDate desc LIMIT {$startpoint} , {$limit}";
