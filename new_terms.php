...
$images = "SELECT count(id) FROM post_format where status='Active' ORDER by id ASC";
...
$result = mysqli_query($con, "SELECT * FROM post_format where status='Active' ORDER by id ASC LIMIT $offset, $per_page");
...
<article class="entry clearfix">
                ...
                <div class="entry-body">
                    <div="entry-title"><h3><?php echo $title;?></h3></div>
...
<?php }//Close the while array loop
...
if ($page) {
echo '<a href="new_terms.php"><button><<</button></a>';//Button for first page [<<]
echo '<a href="new_terms.php?page='.$page_down.'"><button><</button></a>';//Button for previous page [<]
} 

for ($i=1;$i<=$pages_total;$i++) {
if(($i==$page+1)) {
echo '<a href="new_terms.php?page='.$i.'"><button class="active">'.$i.'</button></a>';//Button for active page, underlined using 'active' class
}
...
echo '<a href="new_terms.php?page='.$i.'"><button>'.$i.'</button></a>'; }
} 

if (($page + 1) != $pages_total) {
echo '<a href="new_terms.php?page='.$page_up.'"><button>></button></a>';//Button for next page [>]
echo '<a href="new_terms.php?page='.$pages_total.'"><button>>></button></a>';//Button for last page [>>]
}
