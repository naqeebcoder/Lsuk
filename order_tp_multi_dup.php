...
<head>
    ...
    if (isset($_POST['submit']) && isset($captcha_flag) && $captcha_flag == 1) {
        ...
        <caption align='center' style='background: grey;color: white;padding: 5px;'>Order for " . $communication_type . " Interpreting</caption>
        <table class='myTable'>
        <tr>
                ...
                <form class="sky-form" action="" method="post">
                        ...
                        <div class="panel-body">
                            ...
                            <center>
                                <div class="form-group">
                                    <div class="radio-inline ri"><label><input onchange="av(this);" name="cls_checker" type="radio" value="a" <?php if ($check == 'a') {
                                                                                                                                                    echo "checked";
                                                                                                                                                } ?> />
                                            <span class="label label-info">Audio Interpreting</span></label></div>
                                    <div class="radio-inline ri"><label><input onchange="av(this);" name="cls_checker" type="radio" value="v" <?php if ($check == 'v') {
                                                                                                                                                    echo "checked";
                                                                                                                                                } ?> />
                                            <span class="label label-warning">Video Interpreting</span></label></div>
                                    <div class="radio-inline ri"><label><input onchange="av(this);" name="cls_checker" type="radio" value="b" <?php if ($check == 'b') {
                                                                                                                                                    echo "checked";
                                                                                                                                                } ?> />
                            ...
                            <div class="form-group col-md-3 col-sm-6" id="div_tpc">
                                ...
                                <select name="telep_cat" id="telep_cat" class="form-control" onchange="get_telep_type($(this));" required>
                                    <?php $q_telep_cat = $acttObj->read_all("tpc_id,tpc_title", "telep_cat", "tpc_status=1 ORDER BY tpc_title ASC");
                                    $opt_tpc = "";
                            ...
                            <div class="form-group col-md-4 col-sm-6" id="div_tpt" <?php if ($telep_cat == '11') {
                                                                                        echo "style='display:none;'";
                                                                                    } ?>>
                                <label>Select Telephone Details</label>
                                <select name="telep_type[]" multiple="multiple" id="telep_type" class="form-control multi_class" <?php if ($telep_cat != '11') {
                                                                                                                                        echo "required";
                                                                                                                                    } ?>>
                            ...
                            <div class="form-group col-md-5 col-sm-6" id="div_assignIssue" <?php if ($telep_cat != '11') {
                                                                                                echo "style='display:none;'";
                                                                                            } ?>>
                                <textarea title="Assignment Issue" placeholder="Write Assignment Issue Here ..." name="assignIssue" type="text" class="form-control" id="assignIssue" style="height: 60px;"><?php echo $assignIssue; ?></textarea>
                            </div>
                    ...
                    <div class="panel panel-primary setup-content" id="step-2">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="form-group col-md-4 col-sm-6">
                                <label class="control-label input">Telephone Number (Client)*</label>
                                <input type="text" class="form-control" id="noClient" name="noClient" required='' value="<?php echo $noClient; ?>" />
                            </div>
                            <div class="form-group col-md-4 col-sm-6">
                                <label class="control-label input">Telephone Number <i class="fa fa-question-circle" title="IF Service User Is Not Present"></i></label>
