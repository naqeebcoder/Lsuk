...
<section id="page-title">
    ...
    <!-- begin content -->
    <section id="content" class="container clearfix">
      <p>LSUK Limited provides high quality  translation, proofreading and editing service. We guarantee&nbsp;100%&nbsp;satisfaction. All our  proof-readers are highly qualified native speakers. The price is worked out at  a flat rate per thousand words, so you know exactly how much the editing will  cost in advance. Please check with us</p>
      <p>Please use the form below to send us your documents</p>
<p></p>
<p><br/>
        <br/>
       <a href="<?php if(isset($_SESSION['cust_UserName'])){echo 'customer_area_slct_comp.php?interp=order_translation_prem.php';}else{echo 'order_translation.php';} ?>" class="button">Order for Proofreading</a>
      </p>
    </section>
    <!-- end content -->  
